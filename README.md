...
6. [Hotel Bookings Analysis](https://github.com/Trevor20/SQL-PowerBI-Portfolio/tree/main/projects/Project5-CoffeeRetailAnalysis) - This project analyzes hotel transactions to uncover insights on customer trends, booking patterns and market share. The dataset contains 1 fact table of 118k booking transactions across 2 years, along with 6 dimension tables created on excel to add complexity. The dataset was processed using an ETL pipeline in SQL, and initial data analysis was done using aggregations, window functions and segmented CTEs. The final analysis was presented through an interactive Power BI dashboard, leveraging advance DAX measures to visualize sales trends, top products, and profitability.
